if (function(t, e) {
    ...
    function p(t, e, n, i, o) {
        for (var r, s, a, l, u, p, f = e.createDocumentFragment(), d = [], g = 0, m = t.length; g < m; g++)
            if (r = t[g],
            r || 0 === r)
                if ("object" === rt.type(r))
                    rt.merge(d, r.nodeType ? [r] : r);
                else if (qt.test(r)) {
        ...
        g = 0; r = d[g++]; )
            if (i && rt.inArray(r, i) > -1)
                o && o.push(r);
            else if (u = rt.contains(r.ownerDocument, r),
    ...
    function T(t, e, n, i) {
        ...
        if (m || f > 1 && "string" == typeof g && !it.checkClone && Bt.test(g))
            return t.each(function(o) {
                var r = t.eq(o);
                m && (e[0] = g.call(this, o, r.html())),
                T(r, e, n, i)
            });
        if (f && (o = p(e, t[0].ownerDocument, !1, t, i),
        r = o.firstChild,
        1 === o.childNodes.length && (o = r),
        r || i)) {
            for (s = rt.map(c(o, "script"), y),
            a = s.length; h < f; h++)
                l = o,
                h !== d && (l = rt.clone(l, !0, !0),
                a && rt.merge(s, c(l, "script"))),
                n.call(t[h], l, h);
            if (a)
                ...
                h = 0; h < a; h++)
                    l = s[h],
                    Ht.test(l.type || "") && !Et.access(l, "globalEval") && rt.contains(u, l) && (l.src ? rt._evalUrl && rt._evalUrl(l.src) : rt.globalEval(l.textContent.replace(zt, "")))
        }
        return t
    }
    function C(t, e, n) {
        for (var i, o = e ? rt.filter(e, t) : t, r = 0; null != (i = o[r]); r++)
            ...
            i.parentNode && (n && rt.contains(i.ownerDocument, i) && h(c(i, "script")),
    ...
    function E(t) {
        var e = Y
          , n = Xt[t];
        return n || (n = S(t, e),
        "none" !== n && n || (Vt = (Vt || rt("<iframe frameborder='0' width='0' height='0'/>")).appendTo(e.documentElement),
    ...
    function k(t, e, n) {
        ...
        n && !it.pixelMarginRight() && Yt.test(s) && Qt.test(e) && (i = a.width,
        o = a.minWidth,
        r = a.maxWidth,
    ...
    function D(t, e, n, i, o) {
        for (var r = n === (i ? "border" : "content") ? 4 : "width" === e ? 1 : 0, s = 0; r < 4; r += 2)
            "margin" === n && (s += rt.css(t, n + jt[r], !0, o)),
            i ? ("content" === n && (s -= rt.css(t, "padding" + jt[r], !0, o)),
            "margin" !== n && (s -= rt.css(t, "border" + jt[r] + "Width", !0, o))) : (s += rt.css(t, "padding" + jt[r], !0, o),
            "padding" !== n && (s += rt.css(t, "border" + jt[r] + "Width", !0, o)));
        return s
    }
    function j(t, e, n) {
        var i = !0
        ...
        if (o <= 0 || null == o) {
            ...
            Yt.test(o))
                return o;
            i = s && (it.boxSizingReliable() || o === t.style[e]),
            o = parseFloat(o) || 0
        }
    ...
    function O(t, e) {
        for (var n, i, o, r = [], s = 0, a = t.length; s < a; s++)
            i = t[s],
            i.style && (r[s] = Et.get(i, "olddisplay"),
            n = i.style.display,
            e ? (r[s] || "none" !== n || (i.style.display = ""),
            "" === i.style.display && Ot(i) && (r[s] = Et.access(i, "olddisplay", E(i.nodeName)))) : (o = Ot(i),
            "none" === n && o || Et.set(i, "olddisplay", o ? n : rt.css(i, "display"))));
        for (s = 0; s < a; s++)
            i = t[s],
    ...
    function q(t, e, n) {
        var i, o, r, s, a, l, u, c, h = this, p = {}, f = t.style, d = t.nodeType && Ot(t), g = Et.get(t, "fxshow");
        ...
        u = rt.css(t, "display"),
        c = "none" === u ? Et.get(t, "olddisplay") || E(t.nodeName) : u,
        "inline" === c && "none" === rt.css(t, "float") && (f.display = "inline-block")),
        ...
        if (rt.isEmptyObject(p))
            ...
            g ? "hidden"in g && (d = g.hidden) : g = Et.access(t, "fxshow", {}),
            r && (g.hidden = !d),
            d ? rt(t).show() : h.done(function() {
                rt(t).hide()
            }),
            h.done(function() {
                var e;
    ...
    function _(t, e, n) {
        var i, o, r = 0, s = _.prefilters.length, a = rt.Deferred().always(function() {
            ...
            if (o)
                return !1;
            for (var e = oe || L(), n = Math.max(0, u.startTime + u.duration - e), i = n / u.duration || 0, r = 1 - i, s = 0, l = u.tweens.length; s < l; s++)
                u.tweens[s].run(r);
        ...
        for (P(c, u.opts.specialEasing); r < s; r++)
            if (i = _.prefilters[r].call(u, t, c, u.opts))
                return rt.isFunction(i.stop) && (rt._queueHooks(u.elem, u.opts.queue).stop = rt.proxy(i.stop, i)),
                i;
        return rt.map(c, R, u),
        ...
        a--); a < l; a++)
            if (null != (t = arguments[a]))
                for (e in t)
                    n = s[e],
                    i = t[e],
                    s !== i && (u && i && (rt.isPlainObject(i) || (o = rt.isArray(i))) ? (o ? (o = !1,
                    r = n && rt.isArray(n) ? n : []) : r = n && rt.isPlainObject(n) ? n : {},
                    s[e] = rt.extend(u, r, i)) : void 0 !== i && (s[e] = i));
        return s
    }
    ,
    rt.extend({
    ...
    var ct = function(t) {
        function e(t, e, n, i) {
            ...
            "string" != typeof t || !t || 1 !== g && 9 !== g && 11 !== g)
                return n;
            if (!i && ((e ? e.ownerDocument || e : F) !== O && j(e),
            e = e || O,
            L)) {
                if (11 !== g && (u = vt.exec(t)))
                    if (o = u[1]) {
                        if (9 === g) {
                            ...
                            if (s.id === o)
                                return n.push(s),
                                n
                        } else if (d && (s = d.getElementById(o)) && P(e, s) && s.id === o)
                            return n.push(s),
                            n
                    } else {
                        if (u[2])
                ...
                if (x.qsa && !z[t + " "] && (!H || !H.test(t))) {
                    if (1 !== g)
                        ...
                        for ((a = e.getAttribute("id")) ? a = a.replace(bt, "\\$&") : e.setAttribute("id", a = _),
                        h = E(t),
                        r = h.length,
            ...
            i(function(i, s, a, l) {
                ...
                if (i) {
                    if (r || t) {
                        ...
                        for (c = b.length; c--; )
                            (h = b[c]) && (u = r ? tt(i, h) : p[c]) > -1 && (i[u] = !(s[u] = h))
                    }
                } else
        ...
        var w, x, T, C, S, E, k, $, N, A, D, j, O, I, L, H, R, q, P, _ = "sizzle" + 1 * new Date, F = t.document, M = 0, W = 0, B = n(), U = n(), z = n(), V = function(t, e) {
            return t === e && (D = !0),
            0
        ...
        j = e.setDocument = function(t) {
            ...
            I = O.documentElement,
            L = !S(O),
            (n = O.defaultView) && n.top !== n && (n.addEventListener ? n.addEventListener("unload", Tt, !1) : n.attachEvent && n.attachEvent("onunload", Tt)),
            ...
            R = [],
            H = [],
            (x.qsa = mt.test(O.querySelectorAll)) && (o(function(t) {
                I.appendChild(t).innerHTML = "<a id='" + _ + "'></a><select id='" + _ + "-\r\\' msallowcapture=''><option selected=''></option></select>",
                t.querySelectorAll("[msallowcapture^='']").length && H.push("[*^$]=" + nt + "*(?:''|\"\")"),
                t.querySelectorAll("[selected]").length || H.push("\\[" + nt + "*(?:value|" + et + ")"),
                t.querySelectorAll("[id~=" + _ + "-]").length || H.push("~="),
                t.querySelectorAll(":checked").length || H.push(":checked"),
                t.querySelectorAll("a#" + _ + "+*").length || H.push(".#.+[+~]")
            }),
            o(function(t) {
            ...
            P = e || mt.test(I.contains) ? function(t, e) {
            ...
            V = e ? function(t, e) {
                ...
                1 & n || !x.sortDetached && e.compareDocumentPosition(t) === n ? t === O || t.ownerDocument === F && P(F, t) ? -1 : e === O || e.ownerDocument === F && P(F, e) ? 1 : A ? tt(A, t) - tt(A, e) : 0 : 4 & n ? -1 : 1)
            }
            : function(t, e) {
                if (t === e)
                    return D = !0,
        ...
        e.matchesSelector = function(t, n) {
            ...
            n = n.replace(ct, "='$1']"),
            x.matchesSelector && L && !z[n + " "] && (!R || !R.test(n)) && (!H || !H.test(n)))
                try {
                    var i = q.call(t, n);
        ...
        e.attr = function(t, e) {
            ...
            var n = T.attrHandle[e.toLowerCase()]
              , i = n && Q.call(T.attrHandle, e.toLowerCase()) ? n(t, e, !L) : void 0;
        ...
        T = e.selectors = {
            ...
            preFilter: {
                ...
                PSEUDO: function(t) {
                    var e, n = !t[6] && t[2];
                    return ft.CHILD.test(t[0]) ? null : (t[3] ? t[2] = t[4] || t[5] || "" : n && ht.test(n) && (e = E(n, !0)) && (e = n.indexOf(")", n.length - e) - n.length) && (t[0] = t[0].slice(0, e),
                    t[2] = n.slice(0, e)),
                    t.slice(0, 3))
                }
            },
                    ...
                    : function(e, n, l) {
                        ...
                        if (m) {
                            ...
                            s && y) {
                                ...
                                f = u[0] === M && u[1],
                                b = f && u[2],
                                p = f && m.childNodes[f]; p = ++f && p && p[g] || (b = f = 0) || d.pop(); )
                            ...
                            b = f),
                            b === !1)
                                for (; (p = ++f && p && p[g] || (b = f = 0) || d.pop()) && ((a ? p.nodeName.toLowerCase() !== v : 1 !== p.nodeType) || !++b || (y && (h = p[_] || (p[_] = {}),
                                c = h[p.uniqueID] || (h[p.uniqueID] = {}),
                                c[t] = [M, b]),
                                p !== e)); )
                                    ;
        ...
        $ = e.select = function(t, e, n, i) {
            ...
            1 === h.length) {
                ...
                r.length > 2 && "ID" === (s = r[0]).type && x.getById && 9 === e.nodeType && L && T.relative[r[1].type]) {
                    if (e = (T.find.ID(s.matches[0].replace(wt, xt), e) || [])[0],
                    !e)
                        return n;
                    u && (e = e.parentNode),
            ...
            return (u || k(t, h))(i, e, !L, n, !e || yt.test(t) && c(e.parentNode) || e),
            n
        }
        ,
        x.sortStable = _.split("").sort(V).join("") === _,
    ...
    var mt, vt = /^(?:\s*(<[\w\W]+>)[^>]*|#([\w-]*))$/, yt = rt.fn.init = function(t, e, n) {
        ...
        "string" == typeof t) {
            ...
            if (i[1]) {
                ...
                rt.merge(this, rt.parseHTML(i[1], e && e.nodeType ? e.ownerDocument || e : Y, !0)),
                dt.test(i[1]) && rt.isPlainObject(e))
                    for (i in e)
                        rt.isFunction(this[i]) ? this[i](e[i]) : this.attr(i, e[i]);
                return this
            }
            return o = Y.getElementById(i[2]),
    ...
    rt.each({
        ...
        rt.fn[t] = function(n, i) {
            ...
            this.length > 1 && (wt[t] || rt.uniqueSort(o),
            bt.test(t) && o.reverse()),
            this.pushStack(o)
        }
    });
    ...
    rt.extend({
        ...
        when: function(t) {
            ...
            if (s > 1)
                ...
                n = new Array(s),
                i = new Array(s); o < s; o++)
                    r[o] && rt.isFunction(r[o].promise) ? r[o].promise().progress(u(o, n, e)).done(u(o, i, r)).fail(l.reject) : --a;
    ...
    rt.extend({
        ...
        ready: function(t) {
            ...
            t !== !0 && --rt.readyWait > 0 || (Tt.resolveWith(Y, [rt]),
            rt.fn.triggerHandler && (rt(Y).triggerHandler("ready"),
            rt(Y).off("ready"))))
        }
    }),
    rt.ready.promise = function(e) {
        return Tt || (Tt = rt.Deferred(),
        "complete" === Y.readyState || "loading" !== Y.readyState && !Y.documentElement.doScroll ? t.setTimeout(rt.ready) : (Y.addEventListener("DOMContentLoaded", s),
        ...
        remove: function(t, e) {
            ...
            if (void 0 !== r) {
                if (void 0 === e)
                    ...
                    rt.isArray(e) ? i = e.concat(e.map(rt.camelCase)) : (o = rt.camelCase(e),
                    e in r ? i = [e, o] : (i = o,
                    i = i in r ? [i] : i.match(xt) || [])),
                    n = i.length;
                    for (; n--; )
                        delete r[i[n]]
                }
    ...
    rt.fn.extend({
        data: function(t, e) {
            ...
            if (void 0 === t) {
                if (this.length && (o = kt.get(r),
                1 === r.nodeType && !Et.get(r, "hasDataAttrs"))) {
                    for (n = s.length; n--; )
                        s[n] && (i = s[n].name,
                        0 === i.indexOf("data-") && (i = rt.camelCase(i.slice(5)),
                        l(r, i, o[i])));
                    Et.set(r, "hasDataAttrs", !0)
                }
                return o
            }
            return "object" == typeof t ? this.each(function() {
                ...
                var n, i;
                if (r && void 0 === e) {
                    if (n = kt.get(r, t) || kt.get(r, t.replace(Nt, "-$&").toLowerCase()),
                    void 0 !== n)
                        return n;
                    if (i = rt.camelCase(t),
                    n = kt.get(r, i),
    ...
    rt.extend({
        queue: function(t, e, n) {
            ...
            if (t)
                return e = (e || "fx") + "queue",
                i = Et.get(t, e),
                n && (!i || rt.isArray(n) ? i = Et.access(t, e, rt.makeArray(n)) : i.push(n)),
                i || []
        },
    ...
    rt.event = {
        ...
        add: function(t, e, n, i, o) {
            var r, s, a, l, u, c, h, p, f, d, g, m = Et.get(t);
            if (m)
                for (n.handler && (r = n,
                n = r.handler,
                o = r.selector),
                ...
                u = e.length; u--; )
                    ...
                    f = g = a[1],
                    d = (a[2] || "").split(".").sort(),
                    f && (h = rt.event.special[f] || {},
                    f = (o ? h.delegateType : h.bindType) || f,
                    h = rt.event.special[f] || {},
                    c = rt.extend({
                        type: f,
                        origType: g,
                        data: i,
                    ...
                    (p = l[f]) || (p = l[f] = [],
                    p.delegateCount = 0,
                    h.setup && h.setup.call(t, i, d, s) !== !1 || t.addEventListener && t.addEventListener(f, s)),
        ...
        remove: function(t, e, n, i, o) {
            var r, s, a, l, u, c, h, p, f, d, g, m = Et.hasData(t) && Et.get(t);
            if (m && (l = m.events)) {
                for (e = (e || "").match(xt) || [""],
                u = e.length; u--; )
                    if (a = Ft.exec(e[u]) || [],
                    ...
                    f) {
                        ...
                        s && !p.length && (h.teardown && h.teardown.call(t, d, m.handle) !== !1 || rt.removeEvent(t, f, m.handle),
                        delete l[f])
                    } else
                        for (f in l)
                            rt.event.remove(t, f + e[u], n, i, !0);
                rt.isEmptyObject(l) && Et.remove(t, "handle events")
            }
        },
        dispatch: function(t) {
            t = rt.event.fix(t);
            var e, n, i, o, r, s = [], a = G.call(arguments), l = (Et.get(this, "events") || {})[t.type] || [], u = rt.event.special[t.type] || {};
            if (a[0] = t,
            ...
            !u.preDispatch || u.preDispatch.call(this, t) !== !1) {
                ...
                e = 0; (o = s[e++]) && !t.isPropagationStopped(); )
                    ...
                    n = 0; (r = o.handlers[n++]) && !t.isImmediatePropagationStopped(); )
                        ...
                        t.data = r.data,
                        i = ((rt.event.special[r.origType] || {}).handle || r.handler).apply(o.elem, a),
                ...
                for (; l !== this; l = l.parentNode || this)
                    if (1 === l.nodeType && (l.disabled !== !0 || "click" !== t.type)) {
                        ...
                        n = 0; n < a; n++)
                            r = e[n],
                            o = r.selector + " ",
                            void 0 === i[o] && (i[o] = r.needsContext ? rt(o, this).index(l) > -1 : rt.find(o, this, null, [l]).length),
                            i[o] && i.push(r);
                        i.length && s.push({
                            elem: l,
                            handlers: i
        ...
        fix: function(t) {
            ...
            for (s || (this.fixHooks[o] = s = _t.test(o) ? this.mouseHooks : Pt.test(o) ? this.keyHooks : {}),
    ...
    rt.Event = function(t, e) {
        ...
        this.type = t.type,
        this.isDefaultPrevented = t.defaultPrevented || void 0 === t.defaultPrevented && t.returnValue === !1 ? f : d) : this.type = t,
        e && rt.extend(this, e),
    ...
    rt.each({
        ...
        rt.event.special[t] = {
            ...
            handle: function(t) {
                ...
                return o && (o === i || rt.contains(i, o)) || (t.type = r.origType,
    ...
    rt.each({
        ...
        rt.fn[t] = function(t) {
            for (var n, i = [], o = rt(t), r = o.length - 1, s = 0; s <= r; s++)
    ...
    rt.extend({
        ...
        style: function(t, e, n, i) {
            if (t && 3 !== t.nodeType && 8 !== t.nodeType && t.style) {
                ...
                return e = rt.cssProps[a] || (rt.cssProps[a] = N(a) || a),
                s = rt.cssHooks[e] || rt.cssHooks[a],
                void 0 === n ? s && "get"in s && void 0 !== (o = s.get(t, !1, i)) ? o : l[e] : (r = typeof n,
                "string" === r && (o = Dt.exec(n)) && o[1] && (n = u(t, e, o),
                r = "number"),
                null != n && n === n && ("number" === r && (n += o && o[3] || (rt.cssNumber[a] ? "" : "px")),
    ...
    rt.each(["height", "width"], function(t, e) {
        rt.cssHooks[e] = {
            get: function(t, n, i) {
                if (n)
                    return Zt.test(rt.css(t, "display")) && 0 === t.offsetWidth ? Kt(t, te, function() {
                        return j(t, e, i)
                    }) : j(t, e, i)
            },
            set: function(t, n, i) {
                var o, r = i && Gt(t), s = i && D(t, e, i, "border-box" === rt.css(t, "boxSizing", !1, r), r);
                return s && (o = Dt.exec(n)) && "px" !== (o[3] || "px") && (t.style[e] = n,
                n = rt.css(t, e)),
                A(t, n, s)
            }
        }
    ...
    rt.cssHooks.marginLeft = $(it.reliableMarginLeft, function(t, e) {
        if (e)
            return (parseFloat(k(t, "marginLeft")) || t.getBoundingClientRect().left - Kt(t, {
                marginLeft: 0
            }, function() {
    ...
    rt.fn.extend({
        ...
        finish: function(t) {
            return t !== !1 && (t = t || "fx"),
            this.each(function() {
                var e, n = Et.get(this), i = n[t + "queue"], o = n[t + "queueHooks"], r = rt.timers, s = i ? i.length : 0;
                for (n.finish = !0,
                rt.queue(this, t, []),
    ...
    rt.extend({
        attr: function(t, e, n) {
            ...
            if (3 !== r && 8 !== r && 2 !== r)
                return "undefined" == typeof t.getAttribute ? rt.prop(t, e, n) : (1 === r && rt.isXMLDoc(t) || (e = e.toLowerCase(),
                o = rt.attrHooks[e] || (rt.expr.match.bool.test(e) ? le : void 0)),
                void 0 !== n ? null === n ? void rt.removeAttr(t, e) : o && "set"in o && void 0 !== (i = o.set(t, n, e)) ? i : (t.setAttribute(e, n + ""),
                n) : o && "get"in o && null !== (i = o.get(t, e)) ? i : (i = rt.find.attr(t, e),
                null == i ? void 0 : i))
        },
        attrHooks: {
            type: {
    ...
    le = {
        set: function(t, e, n) {
            return e === !1 ? rt.removeAttr(t, n) : t.setAttribute(n, n),
            n
        }
    },
        ...
        toggleClass: function(t, e) {
            ...
            return "boolean" == typeof e && "string" === n ? e ? this.addClass(t) : this.removeClass(t) : rt.isFunction(t) ? this.each(function(n) {
                ...
                if ("string" === n)
                    ...
                    this.setAttribute && this.setAttribute("class", e || t === !1 ? "" : Et.get(this, "__className__") || ""))
            })
        },
        hasClass: function(t) {
            var e, n, i = 0;
            for (e = " " + t + " "; n = this[i++]; )
                if (1 === n.nodeType && (" " + F(n) + " ").replace(pe, " ").indexOf(e) > -1)
                    return !0;
            return !1
        }
    });
            ...
            var e, n, i, o = this[0];
            {
                if (arguments.length)
                    ...
                    this.each(function(n) {
                        var o;
                        1 === this.nodeType && (o = i ? t.call(this, n, rt(this).val()) : t,
                        null == o ? o = "" : "number" == typeof o ? o += "" : rt.isArray(o) && (o = rt.map(o, function(t) {
                            return null == t ? "" : t + ""
                        })),
                ...
                if (o)
                    return e = rt.valHooks[o.type] || rt.valHooks[o.nodeName.toLowerCase()],
            ...
            select: {
                get: function(t) {
                    for (var e, n, i = t.options, o = t.selectedIndex, r = "select-one" === t.type || o < 0, s = r ? null : [], a = r ? o + 1 : i.length, l = o < 0 ? a : r ? o : 0; l < a; l++)
                        if (n = i[l],
                        (n.selected || l === o) && (it.optDisabled ? !n.disabled : null === n.getAttribute("disabled")) && (!n.parentNode.disabled || !rt.nodeName(n.parentNode, "optgroup"))) {
                            if (e = rt(n).val(),
                            r)
                                return e;
                            s.push(e)
                ...
                set: function(t, e) {
                    for (var n, i, o = t.options, r = rt.makeArray(e), s = o.length; s--; )
                        i = o[s],
                        (i.selected = rt.inArray(rt.valHooks.option.get(i), r) > -1) && (n = !0);
    ...
    rt.extend(rt.event, {
        trigger: function(e, n, i, o) {
            ...
            if (s = a = i = i || Y,
            3 !== i.nodeType && 8 !== i.nodeType && !ge.test(f + rt.event.triggered) && (f.indexOf(".") > -1 && (d = f.split("."),
            f = d.shift(),
            d.sort()),
            u = f.indexOf(":") < 0 && "on" + f,
            ...
            o || !h.trigger || h.trigger.apply(i, n) !== !1)) {
                if (!o && !h.noBubble && !rt.isWindow(i)) {
                    ...
                    ge.test(l + f) || (s = s.parentNode); s; s = s.parentNode)
                        p.push(s),
                        a = s;
                ...
                for (r = 0; (s = p[r++]) && !e.isPropagationStopped(); )
                    ...
                    c = (Et.get(s, "events") || {})[e.type] && Et.get(s, "handle"),
                    c && c.apply(s, n),
                    c = u && s[u],
                    c && c.apply && St(s) && (e.result = c.apply(s, n),
                    e.result === !1 && e.preventDefault());
                return e.type = f,
                o || e.isDefaultPrevented() || h._default && h._default.apply(p.pop(), n) !== !1 || !St(i) || u && rt.isFunction(i[f]) && !rt.isWindow(i) && (a = i[u],
                a && (i[u] = null),
    ...
    it.focusin || rt.each({
        ...
        rt.event.special[e] = {
            ...
            teardown: function() {
                var i = this.ownerDocument || this
                  , o = Et.access(i, e) - 1;
                o ? Et.access(i, e, o) : (i.removeEventListener(t, n, !0),
                Et.remove(i, e))
            }
        }
    });
    ...
    rt.extend({
        ...
        ajax: function(e, n) {
            function i(e, n, i, a) {
                ...
                i && (b = U(p, T, i)),
                b = z(p, b, T, u),
                u ? (p.ifModified && (x = T.getResponseHeader("Last-Modified"),
                x && (rt.lastModified[r] = x),
                ...
                T.status = e,
                T.statusText = (n || C) + "",
                u ? g.resolveWith(f, [h, C, T]) : g.rejectWith(f, [T, C, y]),
                T.statusCode(v),
                v = void 0,
                c && d.trigger(u ? "ajaxSuccess" : "ajaxError", [T, p, u ? h : y]),
                m.fireWith(f, [T, C]),
            ...
            T.success = T.done,
            T.error = T.fail,
            p.url = ((e || p.url || me.href) + "").replace(be, "").replace(Se, me.protocol + "//"),
            p.type = n.method || n.type || p.method || p.type,
            p.dataTypes = rt.trim(p.dataType || "*").toLowerCase().match(xt) || [""],
            null == p.crossDomain) {
                u = Y.createElement("a");
                try {
                    u.href = p.url,
            ...
            r = p.url,
            p.hasContent || (p.data && (r = p.url += (ye.test(r) ? "&" : "?") + p.data,
            delete p.data),
            p.cache === !1 && (p.url = we.test(r) ? r.replace(we, "$1_=" + ve++) : r + (ye.test(r) ? "&" : "?") + "_=" + ve++)),
            p.ifModified && (rt.lastModified[r] && T.setRequestHeader("If-Modified-Since", rt.lastModified[r]),
            rt.etag[r] && T.setRequestHeader("If-None-Match", rt.etag[r])),
            ...
            if (p.beforeSend && (p.beforeSend.call(f, T, p) === !1 || 2 === w))
                return T.abort();
            x = "abort";
            for (h in {
                success: 1,
    ...
    rt.ajaxPrefilter("json jsonp", function(e, n, i) {
        ...
        if (a || "jsonp" === e.dataTypes[0])
            return o = e.jsonpCallback = rt.isFunction(e.jsonpCallback) ? e.jsonpCallback() : e.jsonpCallback,
            a ? e[a] = e[a].replace(qe, "$1" + o) : e.jsonp !== !1 && (e.url += (ye.test(e.url) ? "&" : "?") + e.jsonp + "=" + o),
    ...
    rt.parseHTML = function(t, e, n) {
        ...
        var i = dt.exec(t)
          , o = !n && [];
        return i ? [e.createElement(i[1])] : (i = p([t], e, o),
    ...
    rt.fn.extend({
        offset: function(t) {
            ...
            if (r)
                ...
                rt.contains(e, i) ? (o = i.getBoundingClientRect(),
                n = X(r),
                {
    ...
    rt.each(["top", "left"], function(t, e) {
        rt.cssHooks[e] = $(it.pixelPosition, function(t, n) {
            if (n)
                return n = k(t, e),
                Yt.test(n) ? rt(t).position()[e] + "px" : n
        })
    }),
    rt.each({
        Height: "height",
...
!function(t, e) {
    ...
    e.prototype = {
        ...
        lookup: function(e) {
            if (this.query = "undefined" != typeof e && null !== e ? e : this.$element.val() || "",
        ...
        highlighter: function(e) {
            ...
            if (n = l.length,
            0 === n)
                return a.text(e).html();
            for (; u > -1; )
                i = e.substr(0, u),
                o = e.substr(u, n),
                r = e.substr(u + n),
                s = t("<strong></strong>").text(o),
                a.append(document.createTextNode(i)).append(s),
                e = r,
        ...
        render: function(e) {
            ...
            return e = t(e).map(function(e, r) {
                ...
                e.find("a").html(n.highlighter(s)),
                s == i.$element.val() && (e.addClass("active"),
    ...
    t.fn.typeahead = function(n) {
        ...
        return "string" == typeof n && "getActive" == n ? this.data("active") : this.each(function() {
            var o = t(this)
              , r = o.data("typeahead")
              , s = "object" == typeof n && n;
            r || o.data("typeahead", r = new e(this,s)),
    ...
    n.prototype.show = function() {
        ...
        if (this.hasContent() && this.enabled) {
            ...
            if (u) {
                ...
                a = "bottom" == a && c.bottom + p > d.bottom ? "top" : "top" == a && c.top - p < d.top ? "bottom" : "right" == a && c.right + h > d.width ? "left" : "left" == a && c.left - h < d.left ? "right" : a,
...
function(t, e) {
    ...
    : function(t) {
      ...
      , o = function(t) {
        ...
        function o() {
            ...
            a.supportsTransitionEnd() && (t.event.special[a.TRANSITION_END] = e())
        }
        var r = !1
          , s = {
            WebkitTransition: "webkitTransitionEnd",
    ...
    (function(t) {
        var e = "metisMenu"
          ...
          , p = function() {
            ...
            return e.prototype.init = function() {
                ...
                t(this._element).find("li").has("ul").children("a").on(h.CLICK_DATA_API, function(n) {
                    var i = t(this)
                      , o = i.parent("li")
                      , r = o.siblings("li").children("a")
                      , s = o.children("ul");
                    e._config.preventDefault && n.preventDefault(),
                    "true" !== i.attr("aria-disabled") && (o.hasClass(e._config.activeClass) ? (i.attr("aria-expanded", !1),
                    e._hide(s)) : (e._show(s),
                    i.attr("aria-expanded", !0),
                    e._config.toggle && r.attr("aria-expanded", !1)),
            ...
            e.prototype._show = function(e) {
                if (!this._transitioning && !t(e).hasClass(this._config.collapsingClass)) {
                    ...
                    !r.isDefaultPrevented()) {
                        ...
                        return o.supportsTransitionEnd() ? void i.height(i[0].scrollHeight).one(o.TRANSITION_END, s).emulateTransitionEnd(u) : void s()
                    }
                }
            }
            ,
            e.prototype._hide = function(e) {
                if (!this._transitioning && t(e).hasClass(this._config.collapseInClass)) {
                    ...
                    !r.isDefaultPrevented()) {
                        ...
                        return o.supportsTransitionEnd() ? void (0 == i.height() || "none" == i.css("display") ? s() : i.height(0).one(o.TRANSITION_END, s).emulateTransitionEnd(u)) : void s()
                    }
                }
            }
            ,
            ...
            e.prototype.dispose = function() {
                ...
                t(this._element).find("li").has("ul").children("a").off("click"),
                this._transitioning = null,
                this._config = null,
                this._element = null
            }
            ...
            e._jQueryInterface = function(n) {
                return this.each(function() {
                    var o = t(this)
                      , s = o.data(r)
                      , a = t.extend({}, c, o.data(), "object" === ("undefined" == typeof n ? "undefined" : i(n)) && n);
                    if (!s && /dispose/.test(n) && this.dispose(),
                    s || (s = new e(this,a),
                    o.data(r, s)),
                    "string" == typeof n) {
                        if (void 0 === s[n])
        ...
        return t.fn[e] = p._jQueryInterface,
            ...
            return this.each(function() {
                function i(t) {
                    if (c) {
                        ...
                        e(i).closest("." + o.wrapperClass).is(x.parent()) && r(n, !0),
                ...
                function r(t, e, n) {
                    w = !1;
                    var i = t
                      , r = x.outerHeight() - $.outerHeight();
                    if (e && (i = parseInt($.css("top")) + t * parseInt(o.wheelStep) / 100 * $.outerHeight(),
                    i = Math.min(Math.max(i, 0), r),
                    i = t > 0 ? Math.ceil(i) : Math.floor(i),
                    $.css({
                        top: i + "px"
                    })),
                    m = parseInt($.css("top")) / (x.outerHeight() - $.outerHeight()),
                ...
                function s(t) {
                    window.addEventListener ? (t.addEventListener("DOMMouseScroll", i, !1),
                    t.addEventListener("mousewheel", i, !1)) : document.attachEvent("onmousewheel", i)
                }
                function a() {
                    g = Math.max(x.outerHeight() / x[0].scrollHeight * x.outerHeight(), b),
                    $.css({
                        height: g + "px"
                    });
                ...
                function l() {
                    ...
                    m == ~~m) {
                        ...
                        w = !1;
                    return v = m,
                    g >= x.outerHeight() ? void (w = !0) : ($.stop(!0, !0).fadeIn("fast"),
                    void (o.railVisible && k.stop(!0, !0).fadeIn("fast")))
                }
                function u() {
                    o.alwaysVisible || (f = setTimeout(function() {
                        o.disableFadeOut && c || h || p || ($.fadeOut("slow"),
                        k.fadeOut("slow"))
                    }, 1e3))
                }
                ...
                if (x.parent().hasClass(o.wrapperClass)) {
                    var T = x.scrollTop();
                    if ($ = x.siblings("." + o.barClass),
                    k = x.siblings("." + o.railClass),
                    a(),
                    e.isPlainObject(n)) {
                        ...
                        if ("scrollTo"in n)
                            T = parseInt(o.scrollTo);
                        else if ("scrollBy"in n)
                            T += parseInt(o.scrollBy);
                    ...
                    var E = e(y).addClass(o.wrapperClass).css({
                        position: "relative",
                        overflow: "hidden",
                        width: o.width,
                        height: o.height
                    ...
                    var k = e(y).addClass(o.railClass).css({
                        width: o.size,
                        height: "100%",
                        position: "absolute",
                        top: 0,
                    ...
                    x.parent().append($),
                    x.parent().append(k),
                    o.railDraggable && $.bind("mousedown", function(n) {
                        var i = e(document);
                        return p = !0,
                        t = parseFloat($.css("top")),
                        pageY = n.pageY,
                    ...
                    x.bind("touchmove", function(t) {
                        ...
                        t.originalEvent.touches.length) {
                            ...
                            r(e, !0),
                            d = t.originalEvent.touches[0].pageY
                        }
                    }),
                    a(),
                    "bottom" === o.start ? ($.css({
                        top: x.outerHeight() - $.outerHeight()
                    }),
                    r(0, !0)) : "top" !== o.start && (r(e(o.start).position().top, null, !0),
                    o.alwaysVisible || $.hide()),
                    s(this)
                }
            }),
            this
...
function(t, e, n, i) {
    var o = t.fn.peity = function(e, n) {
        return l && this.each(function() {
            var i = t(this)
              , s = i.data("_peity");
            s ? (e && (s.type = e),
            t.extend(s.opts, n)) : (s = new r(i,e,t.extend({}, o.defaults[e], i.data("peity"), n)),
            i.change(function() {
                s.draw()
            }).data("_peity", s)),
            s.draw()
    ...
    s.draw = function() {
        var t = this.opts;
        o.graphers[this.type].call(this, t),
    ...
    o.register("pie", {
        ...
        for (var l = 0, u = o.length, c = 0; l < u; l++)
            c += o[l];
        c || (u = 2,
        c = 1,
        o = [0, 1]);
        var h = 2 * e.radius
          , p = this.prepare(e.width || h, e.height || h)
          , f = p.width()
          , d = p.height()
          , g = f / 2
          , m = d / 2
                ...
                if (1 == E)
                    if (y) {
                        var k = g - .01
                          ...
                          , N = m - y;
                        C = a("path", {
                            d: ["M", g, $, "A", v, v, 0, 1, 1, k, $, "L", k, N, "A", y, y, 0, 1, 0, g, N].join(" ")
                        })
                    } else
                        C = a("circle", {
                            cx: g,
                    ...
                    var A = T + S
                      , D = ["M"].concat(x(T, v), "A", v, v, 0, E > .5 ? 1 : 0, 1, x(A, v), "L");
                    y ? D = D.concat(x(A, y), "A", y, y, 0, E > .5 ? 1 : 0, 0, x(T, y)) : D.push(g, m),
                    T += S,
                    C = a("path", {
                        d: D.join(" ")
                    })
                }
                C.attr("fill", w.call(this, S, l, o)),
                p.append(C)
            }
        }
    }),
    ...
    o.register("line", {
        ...
        , d = f(n.max(r, 0)), g = [0, d], m = 0; m < e.length; m++)
            g.push(p(m), f(e[m]));
        g.push(u, d),
        t.fill && s.append(a("polygon", {
            fill: t.fill,
            points: g.join(" ")
        })),
    ...
    o.register("bar", {
        ...
        , g = 0; g < e.length; g++) {
            ...
            c ? b < 0 ? x = d(n.min(o, 0)) : T = d(n.max(r, 0)) : m = 1,
            m = T - x,
            0 == m && (m = 1,
            o > 0 && c && x--),
            s.append(a("rect", {
...
function() {
    var t, e, n, i, o, r, s, a, l, u, c, h, p, f, d, g, m, v, y, b, w, x, T, C, S, E, k, $, N, A, D, j, O, I, L, H, R, q, P, _, F, M, W, B, U, z, V, X, Q, Y = [].slice, G = {}.hasOwnProperty, K = function(t, e) {
        function n() {
            this.constructor = t
        }
        for (var i in e)
    ...
    j = function() {
        ...
        e = arguments[1],
        t = 3 <= arguments.length ? Y.call(arguments, 2) : [],
    ...
    x = function() {
        var t, e, n, i, o, r, s;
        for (e = arguments[0],
        i = 2 <= arguments.length ? Y.call(arguments, 1) : [],
        r = 0,
        s = i.length; r < s; r++)
            if (n = i[r])
                for (t in n)
    ...
    window.Pace = u,
    x(u, s.prototype),
    A = u.options = x({}, w, window.paceOptions, C()),
    ...
    H = function(t) {
        ...
        if (!k.length && A.ajax) {
            if ("socket" === t && A.ajax.trackWebSockets)
                return !0;
            if (e = t.toUpperCase(),
            J.call(A.ajax.trackMethods, e) >= 0)
                return !0
        }
        return !1
    }
        ...
        function e() {
            ...
            if (null != _ && A.ajax.trackWebSockets) {
                window.WebSocket = function(t, e) {
                    var i;
                    return i = null != e ? new _(t,e) : new _(t),
                    H("socket") && n.trigger("request", {
                        type: "socket",
                        url: t,
                        protocols: e,
                        request: i
    ...
    S().on("request", function(e) {
        ...
        s = e.url,
        !L(s))
            return u.running || A.restartOnRequestAfter === !1 && "force" !== H(r) ? void 0 : (i = arguments,
            n = A.restartOnRequestAfter || 0,
    ...
    t = function() {
        ...
        return t.prototype.watch = function(t) {
            ...
            o = t.url,
            !L(o))
                return n = "socket" === i ? new f(e) : new d(e),
    ...
    r = function() {
        function t() {
            ...
            e = setInterval(function() {
                ...
                t = m(o),
                ++i >= A.eventLag.minSamples && t < A.eventLag.lagThreshold ? (r.progress = 100,
                clearInterval(e)) : r.progress = 100 * (3 / (t + 3))
            }, 50)
        }
        return t
    }(),
    p = function() {
        ...
        return t.prototype.tick = function(t, e) {
            ...
            n = 1 - Math.pow(this.progress / 100, A.easeFactor),
    ...
    u.running = !1,
    E = function() {
        if (A.restartOnPushState)
            return u.restart()
    }
    ,
    null != window.history.pushState && (z = window.history.pushState,
    window.history.pushState = function() {
        return E(),
        z.apply(window.history, arguments)
    }
    ),
    ...
    ($ = function() {
        ...
        o = s.length; n < o; n++)
            t = s[n],
            A[t] !== !1 && q.push(new h[t](A[t]));
        for (l = null != (a = A.extraSources) ? a : [],
        i = 0,
        r = l.length; i < r; i++)
            R = l[i],
            q.push(new R(A));
    ...
    u.go = function() {
        ...
        g = O(function(e, n) {
            ...
            w = q.length; m < w; l = ++m)
                for (R = q[l],
                d = null != I[l] ? I[l] : I[l] = [],
                a = null != (T = R.elements) ? T : [R],
                c = b = 0,
                x = a.length; b < x; c = ++b)
                    s = a[c],
                    f = null != d[c] ? d[c] : d[c] = new p(s),
                    r &= f.done,
                    f.done || (o++,
                    g += f.tick(e));
            return i = g / o,
        ...
        o.prototype.vendorSet = function(t, e) {
            ...
            for (n in e)
                ...
                i.push(function() {
                    ...
                    i = s.length; e < i; e++)
                        r = s[e],
                        a.push(t["" + r + n.charAt(0).toUpperCase() + n.substr(1)] = o);
                    return a
                }
                .call(this));
            return i
